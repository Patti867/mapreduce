...
public class friendrecommenderjob extends Configured implements Tool {
    @Override
    public int run(String[] args) throws Exception {
        ...
        job.setJobName("Friends recommended Job");


        job.setInputFormatClass(KeyValueTextInputFormat.class);
        job.setOutputFormatClass(TextOutputFormat.class);

        job.setJarByClass(friendrecommenderjob.class);
    ...
    public static void main(String args[]) throws Exception {
        ToolRunner.run(new friendrecommenderjob(), args);
    }
